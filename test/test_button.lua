...
return function()
	describe("button", function()
		...
		test("it should be clickable", function()
			...
			gooey.button("button", gooey.TOUCH, actions.pressed(10, 10), click)
			gooey.button("button", gooey.TOUCH, actions.released(10, 10), click)
		...
		test("it should not treat a press inside and release outside as a click", function()
			...
			local click = callback_listener()
			gooey.button("button", gooey.TOUCH, actions.pressed(10, 10), click)
			gooey.button("button", gooey.TOUCH, actions.released(0, 0), click)
			assert(click.calls == 0)
		end)
		...
		test("it should not treat a press outside and release inside as a click", function()
			...
			local click = callback_listener()
			gooey.button("button", gooey.TOUCH, actions.pressed(0, 0), click)
			gooey.button("button", gooey.TOUCH, actions.released(10, 10), click)
			assert(click.calls == 0)
		end)
		...
		test("it should notify state changes", function()
			...
			-- move outside
			gooey.button("button", gooey.TOUCH, actions.move(0, 0), click, refresh)
			
			-- move over
			gooey.button("button", gooey.TOUCH, actions.move(10, 10), click, refresh)
			...
			-- released
			gooey.button("button", gooey.TOUCH, actions.released(10, 10), click, refresh)
